            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="block-heading">
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                <h1><?=t('app','Your ICOs team leader');?><span class="info"><?=t('app','Tell us more about your ICOs management');?>.</span></h1>
                            </div>
                ...
                <?php if (options()->get('app.settings.common.disableStore', 0) == 0) { ?>
                    <div class="block">
                        <div class="block-heading">
                            <div class="row">
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <h1><?=t('app','Dashboard');?><span class="info"><?=t('app','Update corporate information');?>.</span></h1>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                ...
                <div class="block">
                    <div class="block-heading">
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                <h1><?=t('app','Change Password');?><span class="info"><?=t('app','Keep your password secure');?>.</span></h1>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                ...
                <div class="block">
                    <div class="block-heading">
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                <h1><?=t('app','Change Email');?><span class="info"><?=t('app','Choose an email address for signing in');?>.</span></h1>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                ...
                <div class="block">
                    <div class="block-heading">
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                <h1><?=t('app','Delete Account');?><span class="info"><?=t('app','Terminate your account on ICOdiagram.');?></span></h1>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
