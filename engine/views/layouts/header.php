                        ...
                        <div class="main-navigation">
                            ...
                            <div class="btn-group hidden-xs">
                                <a href="javascript:;" class="btn-as transparent dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                  <i class="fa fa-area-chart" aria-hidden="true"></i><?=t('app','Account');?> 
                                </a>
                            ...
                            <div class="btn-group hidden-xs">
                                <a href="<?=url(['/listing/post']);?>" class="btn-as reverse"><i class="fa fa-plus" aria-hidden="true"></i><?=t('app','Publish ICO');?></a>
                            </div>
                        </div>
                    </div>
                </div>
